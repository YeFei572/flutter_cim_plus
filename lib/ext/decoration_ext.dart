...
extension DecorationColorExt on Color {
  ...
  Decoration borderDecoration({double? borderRadius, double width = 2}) {
    return BoxDecoration(
      borderRadius: borderRadius != null
          ...
          : BorderRadius.zero,
      border: Border.all(color: this, width: width.w),
    );
  }
  ...
  Decoration bottomBorder(
    ...
    return BoxDecoration(
        ...
        border: Border(
          bottom: bottom
              ? BorderSide(color: this, width: width ?? 1.w)
              : BorderSide.none,
          top: top
              ? BorderSide(color: this, width: width ?? 1.w)
              : BorderSide.none,
...
extension DecorationExt on int {
  Decoration topLeftRightDecoration(Color color) {
    return ShapeDecoration(
        ...
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.only(
                topLeft: Radius.circular(w), topRight: Radius.circular(w))));
  }
  ...
  Decoration leftDecoration(Color color) {
    return ShapeDecoration(
        ...
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.only(
                bottomLeft: Radius.circular(w), topLeft: Radius.circular(w))));
  }
  ...
  BoxDecoration boxDecoration(Color bgColor,
      {Color borderColor = const Color(0XFFE1E1E1), double borderWith = 0.5}) {
    return BoxDecoration(
  ...
  BoxDecoration boxBorder(
      {Color? borderColor, double borderWith = 0.5, Color? bgColor}) {
    return BoxDecoration(
        shape: BoxShape.rectangle,
        borderRadius: BorderRadius.all(Radius.circular(w)),
        border: Border.all(
            color: borderColor ?? const Color(0XFF000000), width: borderWith),
        color: bgColor);
  }
}
